...
main.add_url_rule('/', 'index', views.list_posts, methods=['GET', 'POST'])
...
main.add_url_rule('/girl/<filename>', 'girl_download', views.girl_download)
main.add_url_rule('/girl/<dirname>/<filename>', 'girl_download2', views.girl_download2)
